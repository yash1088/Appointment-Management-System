...
public class QuebecImple extends UnicastRemoteObject implements MainInterface {
    ...
    HashMap<String, HashMap<String,String>> outer_patient = new HashMap<>();
    ...
    public QuebecImple() throws RemoteException, IOException
    {
    ...
    public synchronized   String bookappointment(String pid, String str) {
        str = str.trim();
        String tempp  = pid.substring(8);//QUEP12342
        ...
        if(tempp.equals("1")){
            ...
            if(outer.size()==0){
                ...
                try {
                    ...
                    System.out.println("Cnt Que"+cntque);
    ...
    public synchronized  String addappointment(String apptype, String appid, String capicity) {
        ...
        System.out.println("After Appointment Adding"+ outer);
...
//        System.out.println("Hello"+outer.get(temp)+rep_que+var);
    ...
    public  void invoke() {
        try {
            ...
            Logger.getLogger(QuebecImple.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public synchronized String swapAppointment(String p_id, String oldAppID, String oldAppType, String newAppID, String newAppType) {
        ...
        if(outer_patient.containsKey(p_id)){ //MTLP1234= P = [MTLM101010]
            ...
            if(newAppType.equals(oldAppType)&&newAppID.contains("QUE")){
                ...
                if(inner_patient.containsKey(oldAppType)){
                    ...
                    //&&oldAppID.equals(inner_patient.get(oldAppType).substring(1,11))
    ...
    public  String listAppointment(String apptype) {
        printLog("\n\nList appointment has been called by QUE admin for the type "+apptype);
        String temp = "";
        String quedata = "";
        ...
        if(outer.get(temp)==null){
            quedata = "No Appointment Available";
        }
        else {
            quedata = outer.get(temp).toString();
        }
...
//        System.out.println("Hello"+outer.get(temp)+rep_que+var);
    ...
    public   void acceptUDP() {
        try{
            DatagramSocket ds_swap = new DatagramSocket(9595);
            ...
            while(true){
                ...
                if(msg1.contains("book")){
                    ...
                    if(outer.get(msg1.substring(4,5))==null){
                        msg_udp = "No Appointments Available";
                        byte [] data = msg_udp.getBytes();
                        DatagramPacket reply = new DatagramPacket(data,data.length,req.getAddress(),req.getPort());
                        ds_swap.send(reply);
                    }
                    else{
                        msg_udp = outer.get(msg1.substring(4,5)).toString();
    ...
    public void printLog(String log){
        try {
            writer.write(log);
            Logger.getLogger(QuebecImple.class.getName()).log(Level.SEVERE, log);
